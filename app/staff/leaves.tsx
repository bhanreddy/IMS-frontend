...
return <TouchableOpacity key={type} style={[styles.typeChip, leaveType === type && styles.typeChipActive]} onPress={() => setLeaveType(type)}>
            ...
            marginRight: 10
                            ...
                            <TextInput style={styles.input} placeholder="YYYY-MM-DD" value={fromDate} onChangeText={setFromDate} />
                        </View>
                        <View style={[styles.inputGroup, {
            flex: 1
          }]}>
                            <Text style={styles.label}>To Date</Text>
                            <TextInput style={styles.input} placeholder="YYYY-MM-DD" value={toDate} onChangeText={setToDate} />
                        </View>
                    </View>

                    <View style={styles.inputGroup}>
                        <Text style={styles.label}>Reason</Text>
                        <TextInput style={[styles.input, styles.textArea]} placeholder="Describe your reason..." multiline numberOfLines={3} value={reason} onChangeText={setReason} textAlignVertical="top" />
                    </View>

                    <TouchableOpacity style={[styles.applyButton, loading && {
          opacity: 0.7
        }]} activeOpacity={0.8} onPress={handleApply} disabled={loading}>
                ...
                <View style={styles.historyList}>
                    {leaves.length === 0 ? <Text style={{
          textAlign: 'center',
          color: '#999',
          marginTop: 20
        }}>No leave history found.</Text> : leaves.map((item, index) => {
return <Animated.View key={item.id} entering={FadeInDown.delay(300 + index * 100).duration(600)} style={styles.historyCard}>
