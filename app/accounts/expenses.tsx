            ...
            <Modal visible={isDeleteModalVisible} transparent={true} animationType="fade">
                <View style={styles.modalOverlay}>
                    <View style={styles.modalContent}>
                        ...
                        <Text style={styles.modalSubtitle}>Please provide a reason for audit logs.</Text>

                        <TextInput
                            style={[styles.input, { height: 80, textAlignVertical: 'top' }]}
                            placeholder="Reason (e.g. Duplicate, Error)"
                            multiline
                            value={deleteReason}
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'flex-end', gap: 10, marginTop: 20 }}>
                            ...
                            <TouchableOpacity
                                ...
                                disabled={deleting}
                            >
                                {deleting ? <ActivityIndicator color="#fff" size="small" /> : <Text style={{ color: '#fff', fontWeight: 'bold' }}>Delete Permanently</Text>}
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
...
const styles = StyleSheet.create({
    ...
    fab: { position: 'absolute', bottom: 30, right: 30, width: 60, height: 60, borderRadius: 30, backgroundColor: '#EF4444', justifyContent: 'center', alignItems: 'center', elevation: 5 },
