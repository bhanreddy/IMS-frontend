          ...
          {selectedExpense && <>
            ...
            <View style={styles.actionRow}>
              {selectedExpense.status === 'pending' && <>
                ...
                {(user?.role === 'admin' || selectedExpense.created_by !== user?.id) && <TouchableOpacity style={[styles.actionBtn, styles.approveBtn]} onPress={() => handleApprove(selectedExpense)}>
    ...
    <Modal visible={isDeleteModalVisible} transparent={true} animationType="fade">
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          }]} placeholder="Reason (e.g. Duplicate, Error)" multiline value={deleteReason} onChangeText={setDeleteReason} />
