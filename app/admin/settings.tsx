            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <Animated.View entering={FadeInDown.delay(100).duration(600)} style={styles.profileCard}>
                    ...
                    <View style={styles.profileInfo}>
                        <Text style={styles.profileName}>{user?.display_name || user?.first_name || 'Admin User'}</Text>
                        <Text style={styles.profileRole} numberOfLines={1}>
                            ID: {user?.id?.substring(0, 8).toUpperCase() || 'UNKNOWN'}
                        </Text>
                ...
                <View style={styles.groupContainer}>
                    ...
                    <View style={styles.groupCard}>
                        ...
                        <View style={styles.divider} />
                        <View style={styles.settingRow}>
                            <View style={[styles.settingIconBox, { backgroundColor: isDark ? 'rgba(59, 130, 246, 0.1)' : '#EFF6FF' }]}>
                                <Ionicons name="language" size={20} color="#3B82F6" />
                            </View>
                            <Text style={styles.settingLabel}>Language (Telugu)</Text>
                            <Switch
                                trackColor={{ false: theme.colors.border, true: theme.colors.primary }}
                                thumbColor={"#fff"}
                ...
                <View style={styles.groupContainer}>
                    ...
                    <View style={[styles.groupCard, { borderColor: theme.colors.danger }]}>
                        <TouchableOpacity
                        ...
                        >
                            <View style={[styles.settingIconBox, { backgroundColor: isDark ? 'rgba(239, 68, 68, 0.1)' : '#FEF2F2' }]}>
