...
export default function ManageContent() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            let table = '';
            let payload: any = { title, description, created_at: new Date().toISOString() };
...
const styles = StyleSheet.create({
    ...
    tabBar: { flexDirection: 'row', backgroundColor: '#fff', padding: 4 },
    tab: { flex: 1, paddingVertical: 12, alignItems: 'center', borderBottomWidth: 2, borderBottomColor: 'transparent' },
    activeTab: { borderBottomColor: ADMIN_THEME.colors.primary },
    tabText: { fontSize: 12, fontWeight: '600', color: '#6b7280' },
    activeTabText: { color: ADMIN_THEME.colors.primary },
    content: { padding: 20 },
    sectionTitle: { fontSize: 18, fontWeight: '700', marginBottom: 16, color: '#111827' },
    input: { backgroundColor: '#fff', borderWidth: 1, borderColor: '#e5e7eb', borderRadius: 8, padding: 12, marginBottom: 16, fontSize: 16 },
    textArea: { height: 80 },
    largeArea: { height: 200 },
    label: { fontSize: 14, fontWeight: '600', marginBottom: 8, color: '#374151' },
    submitBtn: { backgroundColor: ADMIN_THEME.colors.primary, padding: 16, borderRadius: 12, alignItems: 'center' },
