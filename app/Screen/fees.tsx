...
const FeesScreen = () => {
    ...
    const renderFeeItem = ({ item, index }: { item: StudentFee, index: number }) => {
            ...
            >
                ...
                <View style={styles.amountRow}>
                    ...
                    <View style={{ alignItems: 'flex-end' }}>
                        ...
                        <Text style={[styles.amountValue, { color: '#10b981' }]}>₹{item.amount_paid.toLocaleString()}</Text>
                    </View>
                </View>
                    ...
                    <Animated.View entering={FadeInDown.duration(600)} style={styles.summaryCard}>
                        <View style={styles.summaryRow}>
                            ...
                            <View>
                                ...
                                <Text style={[styles.summaryValue, { color: '#fca5a5' }]}>₹{feeData.summary.balance.toLocaleString()}</Text>
                            </View>
                        </View>
                    </Animated.View>
                )}
