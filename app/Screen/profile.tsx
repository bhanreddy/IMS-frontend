                        ...
                        <Image
                            source={{
                                uri: student.photo_url ||
                                    `https://ui-avatars.com/api/?name=${student.first_name}+${student.last_name}&background=random&size=200`
                            }}
                            style={styles.avatar}
                        />
                        <View style={styles.statusBadge}>
                            <View style={[styles.statusDot, { backgroundColor: student.status === 'active' ? '#10B981' : '#EF4444' }]} />
                        </View>
                    </View>
            ...
            >
                ...
                {primaryParent && (
                    <Animated.View entering={FadeInUp.delay(300).duration(500)} style={styles.card}>
                        ...
                        <View style={styles.infoRow}>
                            <InfoItem
                                label={t('profile.guardian_name', 'Name')}
                                value={`${primaryParent.first_name} ${primaryParent.last_name} (${primaryParent.relation})`}
                                icon="person-outline"
                            />
                        </View>
                        <View style={styles.divider} />
